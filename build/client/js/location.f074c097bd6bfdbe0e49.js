...
function submitReview(placeId, review) {
  return new Promise((resolve, reject) => {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.post('/reviews', {
      place_id: placeId,
      description: review,
    })
    .done(resolve)
...
function isLoggedIn() {
  return new Promise((resolve, reject) => {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default.a.get('/users/me')
      .done(resolve)
      .fail(reject);
  });
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Places__ = __webpack_require__(22);
...
function isLoggedIn() {
  return __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.is-logged-in').val() === 'true';
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_place_hbs__ = __webpack_require__(31);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_placeForm_hbs__ = __webpack_require__(32);
...
class Place {
  ...
  toForm() {
    const $form = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(__WEBPACK_IMPORTED_MODULE_2_placeForm_hbs___default()(this));
  ...
  cancelForm() {
    const $place = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(__WEBPACK_IMPORTED_MODULE_1_place_hbs___default()(this));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_materialize__ = __webpack_require__(10);
...
function appendPlace(place) {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()(__WEBPACK_IMPORTED_MODULE_2__DOM__["a" /* default */].places).append(place.$element);
}
...
function hideToast() {
  __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.toast').fadeOut();
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Place__ = __webpack_require__(15);
...
function setupEventListeners() {
  ...
  __WEBPACK_IMPORTED_MODULE_1_jquery___default()(__WEBPACK_IMPORTED_MODULE_4__controllers_UIController__["a" /* DOM */].places).on('click', __WEBPACK_IMPORTED_MODULE_4__controllers_UIController__["a" /* DOM */].placeAddPhotoBtn, function () {
    const $fileInput = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(this).siblings('input');
    $fileInput.click();
  });

  __WEBPACK_IMPORTED_MODULE_1_jquery___default()(__WEBPACK_IMPORTED_MODULE_4__controllers_UIController__["a" /* DOM */].places).on('change', 'input[type=file]', function () {
    getPlace(this).addPhoto(this.files[0]);
  });

  __WEBPACK_IMPORTED_MODULE_1_jquery___default()(__WEBPACK_IMPORTED_MODULE_4__controllers_UIController__["a" /* DOM */].places).on('click', __WEBPACK_IMPORTED_MODULE_4__controllers_UIController__["a" /* DOM */].placeReviewBtn, function () {
  ...
  __WEBPACK_IMPORTED_MODULE_1_jquery___default()(__WEBPACK_IMPORTED_MODULE_4__controllers_UIController__["a" /* DOM */].places).on('click', __WEBPACK_IMPORTED_MODULE_4__controllers_UIController__["a" /* DOM */].placeDeleteBtn, function () {
    ...
    place.delete()
      .then(() => {
        ...
        const placesCount = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__controllers_UIController__["c" /* isLoggedIn */])()) ? __WEBPACK_IMPORTED_MODULE_6__state__["a" /* default */].places.length - 2 : __WEBPACK_IMPORTED_MODULE_6__state__["a" /* default */].places.length - 1;
        ...
        __WEBPACK_IMPORTED_MODULE_4__controllers_UIController__["b" /* Places */].display(placesCount);
      })
      .catch(console.error);
  });
...
function init() {
  ...
  __WEBPACK_IMPORTED_MODULE_3__controllers_APIController__["a" /* default */].findPlaces()
    .then((places) => {
      ...
      return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_4__controllers_UIController__["c" /* isLoggedIn */])();
    })
    .then((loggedIn) => {
      if (loggedIn) {
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"place__item\" data-index=\""
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"place__item\" data-index=\""
    ...
    + "\">\n  <div class=\"card\">\n    <div class=\"card-image hide\"></div>\n\n    <div class=\"card-content\">\n      <div class=\"card-title input-field\">\n        <input id=\"name\" type=\"text\">\n        <label for=\"name\">Name</label>\n      </div>\n\n      <div class=\"input-field\">\n        <textarea id=\"description\" class=\"materialize-textarea\"></textarea>\n        <label for=\"description\">Description</label>\n      </div>\n    </div>\n\n    <div class=\"card-action clearfix\">\n      <div class=\"left\">\n        <input type=\"file\" class=\"hide\" name=\"fileInput\">\n        <a class=\"place__add-photo-btn btn-floating btn-large waves-effect waves-light red\">\n          <i class=\"material-icons\">add_a_photo</i>\n        </a>\n      </div>\n\n      <div class=\"right\">\n        <ul>\n          <li class=\"left\">\n            <a class=\"place__cancel-btn btn-floating btn-large waves-effect waves-light red\">\n              <i class=\"material-icons\">close</i>\n            </a>\n          </li>\n\n          <li class=\"left\">\n            <a class=\"place__create-btn btn-floating btn-large right waves-effect waves-light green accent-3\">\n              <i class=\"material-icons\">check</i>\n            </a>\n          </li>\n        </ul>\n      </div>\n    </div>\n  </div>\n</div>";
},"useData":true});
...
//# sourceMappingURL=location.f074c097bd6bfdbe0e49.js.map